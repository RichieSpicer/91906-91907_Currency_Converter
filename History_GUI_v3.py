...
class Converter:
    ...
    def __init__(self):
        ...
        # self.all_calculations_list = ['$10.00 NZD is $5.90 USD', '$20.00 NZD is $11.80 USD',
        #                               '$30.00 NZD is $17.70 USD', '$40.00 NZD is $23.60 USD',
        #                               '$50.00 NZD is $29.50 USD', '$60.00 NZD is $35.40 USD']

        self.all_calculations_list = ['$10.00 NZD is $5.90 USD', '$20.00 NZD is $11.80 USD',
                                      '$30.00 NZD is $17.70 USD', '$40.00 NZD is $23.60 USD',
                                      '$50.00 NZD is $29.50 USD', 'This is a test']
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        button_details_list = [
            ["Export", "#004C99", lambda: self.export_history(calculations), 0, 0],
